<div class="embed loading" data-brand-slug="<?php echo $attributes['brand']; ?>" data-leaflet-id="<?php if($attributes['leaflet_id'] != null) : echo $attributes['leaflet_id']; else : echo 0; endif; ?>">
