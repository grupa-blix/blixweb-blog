<div class="section section--gray with-overflow section--leaflets">
    <div class="section__header-wrapper">
      <<?php echo $attributes['header-type']; ?>>Zobacz gazetki sieci <?php echo $attributes["brand"]["label"]; ?></<?php echo $attributes['header-type']; ?>>
        <a href="<?php echo 'https://blix.pl/sklep/' . $attributes["brand"]["value"]; ?>">
          <button class="section__btn-cta-top button">Zobacz więcej</button>
        </a>
    </div>
    <div class="swiper section__swiper section__swiper--leaflets section__swiper--leaflets-small" data-leaflets="brand" data-brand="<?php echo $attributes["brand"]["value"]; ?>" data-ga-label="article-single-brandblock-leaflets">
