<div class="socials<?php if(isset($vars->class)) echo ' ' . $vars->class ?>">
    ...
    <?php if(get_field('link_instagram', 'user_' . $vars->author_id)) : ?>
        <a href="<?php echo the_field('link_instagram', 'user_' . $vars->author_id); ?>">
