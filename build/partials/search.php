<form method="get" action="<?php echo home_url(); ?>" role="search" class="article-search">
  ...
  <input type="text" placeholder="<?php echo esc_attr_x('Wyszukaj artykuł...', 'placeholder') ?>" value="<?php echo get_search_query() ?>" name="s" title="<?php echo esc_attr_x('Wyszukaj artykuł...', 'label') ?>" />
</form>